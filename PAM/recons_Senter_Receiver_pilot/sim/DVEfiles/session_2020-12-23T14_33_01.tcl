...
# DVE full session
# Saved on Wed Dec 23 14:33:01 2020
# Designs open: 1
#   Sim: /home/eda/feifan/vlc_plat/PAM/Senter_Receiver_pilot/sim/simv
# Toplevel windows open: 1
# 	TopLevel.1
#   Source.1: tb_senter_receiver.uut_receiver.uut_demodulation
#   Group count = 1
#   Group uut_demodulation signal count = 77
...
#<Session mode="Full" path="/home/eda/feifan/vlc_plat/PAM/Senter_Receiver_pilot/sim/DVEfiles/session.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{98 78} {1669 862}}
...
set HSPane.1 [gui_create_window -type HSPane -parent ${TopLevel.1} -dock_state left -dock_on_new_line true -dock_extent 410]
catch { set Hier.1 [gui_share_window -id ${HSPane.1} -type Hier] }
gui_set_window_pref_key -window ${HSPane.1} -key dock_width -value_type integer -value 410
gui_set_window_pref_key -window ${HSPane.1} -key dock_height -value_type integer -value -1
gui_set_window_pref_key -window ${HSPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 409} {height 498} {dock_state left} {dock_on_new_line true} {child_hier_colhier 491} {child_hier_coltype 111} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_set_window_pref_key -window ${DLPane.1} -key dock_height -value_type integer -value 499
gui_set_window_pref_key -window ${DLPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 191} {height 498} {dock_state left} {dock_on_new_line true} {child_data_colvariable 314} {child_data_colvalue 13} {child_data_coltype 56} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${DriverLoad.1} {{left 0} {top 0} {width 1275} {height 179} {dock_state bottom} {dock_on_new_line false}}
...
gui_show_window -window ${Source.1} -show_state normal -rect {{0 0} {196 312}}
gui_update_layout -id ${Source.1} {{left 0} {top 0} {width 201} {height 337} {show_state normal} {dock_state undocked} {dock_on_new_line false}}
...
if { ![gui_is_db_opened -db {/home/eda/feifan/vlc_plat/PAM/Senter_Receiver_pilot/sim/simv}] } {
gui_sim_run Ucli -exe simv -args { -ucligui} -dir /home/eda/feifan/vlc_plat/PAM/Senter_Receiver_pilot/sim -nosource
}
}
...
gui_set_radix -radix {decimal} -signals {Sim:tb_senter_receiver.uut_receiver.uut_demodulation.LENGTH_PILOT}
gui_set_radix -radix {twosComplement} -signals {Sim:tb_senter_receiver.uut_receiver.uut_demodulation.LENGTH_PILOT}
...
gui_set_radix -radix {decimal} -signals {Sim:tb_senter_receiver.uut_receiver.uut_demodulation.cnt_rec_data}
gui_set_radix -radix {unsigned} -signals {Sim:tb_senter_receiver.uut_receiver.uut_demodulation.cnt_rec_data}
...
gui_set_radix -radix {decimal} -signals {Sim:tb_senter_receiver.uut_receiver.uut_demodulation.S2}
gui_set_radix -radix {unsigned} -signals {Sim:tb_senter_receiver.uut_receiver.uut_demodulation.S2}
...
gui_set_radix -radix {decimal} -signals {Sim:tb_senter_receiver.uut_receiver.uut_demodulation.LENGTH_THRESHOLD}
gui_set_radix -radix {twosComplement} -signals {Sim:tb_senter_receiver.uut_receiver.uut_demodulation.LENGTH_THRESHOLD}

# Global: Highlighting
gui_highlight_signals -color #00ff00 {tb_senter_receiver.uut_receiver.uut_demodulation.syn_demod_valid}
...
gui_open_source -id ${Source.1}  -replace -active tb_senter_receiver.uut_receiver.uut_demodulation /home/eda/feifan/vlc_plat/PAM/Senter_Receiver_pilot/sim/../rtl/demodulation.v
gui_view_scroll -id ${Source.1} -vertical -set 2250
gui_src_set_reusable -id ${Source.1}

# DriverLoad 'DriverLoad.1'
gui_get_drivers -session -id ${DriverLoad.1} -signal tb_senter_receiver.uut_receiver.uut_demodulation.syn_demod_valid_r -time 951000 -starttime 1000000
