...
# DVE full session
# Saved on Wed Dec 23 14:46:40 2020
# Designs open: 1
...
#   Wave.1: 50 signals
#   Group count = 1
#   Group uut_demodulation signal count = 50
...
gui_show_window -window ${TopLevel.2} -show_state normal -rect {{107 88} {1682 874}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 457} {child_wave_right 1113} {child_wave_colname 226} {child_wave_colvalue 226} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_set_radix -radix {state} -signals {Sim:tb_senter_receiver.uut_receiver.uut_demodulation.nxt_state}
...
gui_wv_zoom_timerange -id ${Wave.1} 197862 360711
gui_list_add_group -id ${Wave.1} -after {New Group} {uut_demodulation}
gui_list_select -id ${Wave.1} {tb_senter_receiver.uut_receiver.uut_demodulation.cnt_pilot }
...
gui_list_set_insertion_bar  -id ${Wave.1} -group uut_demodulation  -item {tb_senter_receiver.uut_receiver.uut_demodulation.h_est[11:0]} -position below

gui_marker_move -id ${Wave.1} {C1} 259000
