...
# DVE full session
# Saved on Sun Dec 20 16:24:36 2020
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{98 163} {1480 882}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 440} {height 460} {dock_state left} {dock_on_new_line true} {child_hier_colhier 491} {child_hier_coltype 111} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 222} {height 460} {dock_state left} {dock_on_new_line true} {child_data_colvariable 314} {child_data_colvalue 13} {child_data_coltype 56} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1382} {height 152} {dock_state bottom} {dock_on_new_line true}}
...
gui_show_window -window ${Source.1} -show_state normal -rect {{0 0} {196 338}}
gui_update_layout -id ${Source.1} {{left 0} {top 0} {width 201} {height 363} {show_state normal} {dock_state undocked} {dock_on_new_line false}}
