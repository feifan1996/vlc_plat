...
# DVE full session
# Saved on Wed Dec 23 17:19:45 2020
# Designs open: 1
...
#   Group count = 1
#   Group uut_demodulation signal count = 79
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{98 78} {1666 859}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 406} {height 495} {dock_state left} {dock_on_new_line true} {child_hier_colhier 491} {child_hier_coltype 111} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 188} {height 495} {dock_state left} {dock_on_new_line true} {child_data_colvariable 314} {child_data_colvalue 13} {child_data_coltype 56} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${DriverLoad.1} {{left 0} {top 0} {width 1272} {height 179} {dock_state bottom} {dock_on_new_line false}}
...
gui_show_window -window ${Source.1} -show_state normal -rect {{0 0} {196 314}}
gui_update_layout -id ${Source.1} {{left 0} {top 0} {width 201} {height 339} {show_state normal} {dock_state undocked} {dock_on_new_line false}}
...
gui_load_child_values {tb_senter_receiver.uut_receiver.uut_demodulation}
...
# Global: Highlighting
gui_highlight_signals -color #00ff00 {{tb_senter_receiver.uut_receiver.uut_demodulation.cnt_pilot[3:0]} {tb_senter_receiver.uut_receiver.uut_demodulation.rec_value[13:0]}}
...
gui_view_scroll -id ${Source.1} -vertical -set 3132
gui_src_set_reusable -id ${Source.1}

# DriverLoad 'DriverLoad.1'
gui_get_drivers -session -id ${DriverLoad.1} -signal {tb_senter_receiver.uut_receiver.uut_demodulation.h_est[11:0]} -time 133000 -starttime 133000
