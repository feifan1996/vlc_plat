...
# DVE full session
# Saved on Sun Dec 20 16:28:27 2020
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{98 163} {1479 881}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 439} {height 460} {dock_state left} {dock_on_new_line true} {child_hier_colhier 491} {child_hier_coltype 111} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
set DLPane.1 [gui_create_window -type DLPane -parent ${TopLevel.1} -dock_state left -dock_on_new_line true -dock_extent 222]
catch { set Data.1 [gui_share_window -id ${DLPane.1} -type Data] }
gui_set_window_pref_key -window ${DLPane.1} -key dock_width -value_type integer -value 222
gui_set_window_pref_key -window ${DLPane.1} -key dock_height -value_type integer -value 460
gui_set_window_pref_key -window ${DLPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 221} {height 460} {dock_state left} {dock_on_new_line true} {child_data_colvariable 314} {child_data_colvalue 13} {child_data_coltype 56} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1381} {height 151} {dock_state bottom} {dock_on_new_line true}}
...
gui_show_window -window ${Source.1} -show_state normal -rect {{0 0} {196 339}}
gui_update_layout -id ${Source.1} {{left 0} {top 0} {width 201} {height 364} {show_state normal} {dock_state undocked} {dock_on_new_line false}}
...
gui_sg_addsignal -group "$_session_group_1" { tb_senter_syn.uut_syn.WIDTH_RESULT tb_senter_syn.uut_syn.rec_seq tb_senter_syn.uut_syn.LENGTH_CNT_SIGNAL tb_senter_syn.uut_syn.syn_demodu_data tb_senter_syn.uut_syn.SYN_MEM_ADDR_WIDTH tb_senter_syn.uut_syn.THRESHOLD tb_senter_syn.uut_syn.ad_rec_data_rr tb_senter_syn.uut_syn.syn_demodu_valid_r tb_senter_syn.uut_syn.rec_cur_state tb_senter_syn.uut_syn.mem_rec_data_r tb_senter_syn.uut_syn.rec_nxt_state tb_senter_syn.uut_syn.PAM_ORDER tb_senter_syn.uut_syn.rec_flag_S1_over tb_senter_syn.uut_syn.cnt_signal tb_senter_syn.uut_syn.syn_demodu_ready tb_senter_syn.uut_syn.S0 tb_senter_syn.uut_syn.LENGTH_DATA tb_senter_syn.uut_syn.ad_rec_data tb_senter_syn.uut_syn.S1 tb_senter_syn.uut_syn.AD_CVER_WIDTH tb_senter_syn.uut_syn.result_cov tb_senter_syn.uut_syn.LENGTH_SIGNAL tb_senter_syn.uut_syn.num_xor_rec_loc tb_senter_syn.uut_syn.IDLE tb_senter_syn.uut_syn.arst_n tb_senter_syn.uut_syn.ad_rec_data_r tb_senter_syn.uut_syn.clk tb_senter_syn.uut_syn.rec_flag_S0_over tb_senter_syn.uut_syn.syn_demodu_valid tb_senter_syn.uut_syn.mem_rec_data_rr tb_senter_syn.uut_syn.m_seq_local tb_senter_syn.uut_syn.xor_local_rec tb_senter_syn.uut_syn.rec_flag_IDLE_over tb_senter_syn.uut_syn.LENGTH_M_SEQ }
